      ...
      <section className="relative py-12 sm:py-16 md:py-20 px-4 overflow-hidden bg-gradient-to-r from-[#755f52] to-[#8b7263]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-3 mb-4 sm:mb-6">
            <Shield className="w-8 h-8 sm:w-10 sm:h-12 text-[#BDFF1C]" />
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <Card className="mb-8 sm:mb-12 border-0 shadow-lg">
            <CardContent className="p-4 sm:p-6 md:p-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#755f52] mb-3 sm:mb-4">
          ...
          <div className="mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#755f52] mb-6 sm:mb-8 text-center">
              The 5-Step Vetting Process
            </h2>
            
            <div className="space-y-4 sm:space-y-6">
              {/* Step 1 */}
              <Card className="border-2 border-gray-200 hover:border-[#BDFF1C] hover:shadow-xl transition-all">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-[#BDFF1C] rounded-2xl flex items-center justify-center flex-shrink-0">
                      <span className="text-xl sm:text-2xl font-bold text-white">1</span>
                    </div>
                    <div className="flex-1">
                      <h3 className="text-xl sm:text-2xl font-bold text-[#755f52] mb-2 sm:mb-3">Application Submission</h3>
              ...
              <Card className="border-2 border-gray-200 hover:border-[#BDFF1C] hover:shadow-xl transition-all">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-[#755f52] rounded-2xl flex items-center justify-center flex-shrink-0">
                      <span className="text-xl sm:text-2xl font-bold text-[#c9a882]">2</span>
                    </div>
                    <div className="flex-1">
                      <h3 className="text-xl sm:text-2xl font-bold text-[#755f52] mb-2 sm:mb-3">Portfolio Review</h3>
                      <p className="text-gray-700 mb-3">
              ...
              <Card className="border-2 border-gray-200 hover:border-[#BDFF1C] hover:shadow-xl transition-all">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl sm:text-2xl font-bold text-[#755f52] mb-2 sm:mb-3">Skills Assessment</h3>
                      <p className="text-gray-700 mb-3">
              ...
              <Card className="border-2 border-gray-200 hover:border-[#BDFF1C] hover:shadow-xl transition-all">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl sm:text-2xl font-bold text-[#755f52] mb-2 sm:mb-3">Professionalism Review</h3>
                      <p className="text-gray-700 mb-3">
              ...
              <Card className="border-2 border-gray-200 hover:border-[#BDFF1C] hover:shadow-xl transition-all">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl sm:text-2xl font-bold text-[#755f52] mb-2 sm:mb-3">Tier Assignment</h3>
                      <p className="text-gray-700 mb-3">
          ...
          <Card className="mb-8 border-0 shadow-lg bg-gradient-to-r from-[#f5f1eb] to-[#ebe4d8]">
            <CardContent className="p-4 sm:p-6 md:p-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#755f52] mb-4 sm:mb-6 text-center">
                Why This Matters for You
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div className="flex gap-4">
                  <Shield className="w-8 h-8 text-[#BDFF1C] flex-shrink-0" />
                  <div>
                ...
                <div className="flex gap-4">
                  <Users className="w-8 h-8 text-[#BDFF1C] flex-shrink-0" />
                  <div>
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-r from-[#755f52] to-[#8b7263]">
            <CardContent className="p-4 sm:p-6 md:p-8">
              <div className="text-center">
                ...
                <p className="text-base sm:text-lg text-[#e8dfd1] mb-4 sm:mb-6">
