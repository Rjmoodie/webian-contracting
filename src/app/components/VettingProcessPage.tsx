      ...
      <section className="relative py-12 sm:py-16 md:py-20 px-4 overflow-hidden bg-gradient-to-r from-[#755f52] to-[#8b7263]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-3 mb-4 sm:mb-6">
            <Shield className="w-8 h-8 sm:w-10 sm:h-12 text-primary" />
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6">
            Our Vetting Process
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-white/80 leading-relaxed max-w-3xl mx-auto">
            How we ensure only the best professionals represent the {branding.companyShortName}{' '}brand
          </p>
        </div>
      </section>
      ...
      <section className="py-8 sm:py-12 md:py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <Card className="mb-8 sm:mb-12 border-0 shadow-lg">
            <CardContent className="p-4 sm:p-6 md:p-8">
              ...
              <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-3 sm:mb-4">
                At {branding.companyName}, we don't just connect clients with talent—we guarantee quality. That's why every professional in our network undergoes a comprehensive vetting process before they can represent our brand.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Our three-tier system (Certified, Premium, Elite) helps clients understand the level of expertise they're getting, and all tiers are expected to maintain our standards of professionalism and quality.
              </p>
            </CardContent>
          </Card>
          ...
          <div className="mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-secondary mb-6 sm:mb-8 text-center">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <Card className="border-2 border-gray-200 hover:border-primary hover:shadow-xl transition-all">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary rounded-2xl flex items-center justify-center flex-shrink-0">
                      <span className="text-xl sm:text-2xl font-bold text-white">1</span>
                    </div>
                    <div className="flex-1">
                      <h3 className="text-xl sm:text-2xl font-bold text-secondary mb-2 sm:mb-3">Application Submission</h3>
              ...
              <Card className="border-2 border-gray-200 hover:border-primary hover:shadow-xl transition-all">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-secondary rounded-2xl flex items-center justify-center flex-shrink-0">
                      <span className="text-xl sm:text-2xl font-bold text-[#c9a882]">2</span>
                    </div>
                    <div className="flex-1">
                      <h3 className="text-xl sm:text-2xl font-bold text-secondary mb-2 sm:mb-3">Portfolio Review</h3>
                      <p className="text-gray-700 mb-3">
                        Our review team evaluates submitted work against our quality standards:
                      </p>
                      <ul className="space-y-2">
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
              ...
              <Card className="border-2 border-gray-200 hover:border-primary hover:shadow-xl transition-all">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl sm:text-2xl font-bold text-secondary mb-2 sm:mb-3">Skills Assessment</h3>
                      <p className="text-gray-700 mb-3">
              ...
              <Card className="border-2 border-gray-200 hover:border-primary hover:shadow-xl transition-all">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-secondary rounded-2xl flex items-center justify-center flex-shrink-0">
                      <span className="text-xl sm:text-2xl font-bold text-[#c9a882]">4</span>
                    </div>
                    <div className="flex-1">
                      <h3 className="text-xl sm:text-2xl font-bold text-secondary mb-2 sm:mb-3">Professionalism Review</h3>
                      <p className="text-gray-700 mb-3">
              ...
              <Card className="border-2 border-gray-200 hover:border-primary hover:shadow-xl transition-all">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl sm:text-2xl font-bold text-secondary mb-2 sm:mb-3">Tier Assignment</h3>
                      <p className="text-gray-700 mb-3">
          ...
          <Card className="mb-8 border-0 shadow-lg bg-gradient-to-r from-[#f5f1eb] to-[#ebe4d8]">
            <CardContent className="p-4 sm:p-6 md:p-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-secondary mb-4 sm:mb-6 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-secondary mb-2">Quality Guarantee</h4>
                    <p className="text-gray-700">Every professional has been thoroughly vetted. Our brand stands behind their work.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <Award className="w-8 h-8 text-secondary flex-shrink-0" />
                  <div>
                    <h4 className="font-bold text-secondary mb-2">Clear Expectations</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-secondary mb-2">Peace of Mind</h4>
                    <p className="text-gray-700">No more gambling on unknown providers. All our talent is verified and reliable.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <Camera className="w-8 h-8 text-secondary flex-shrink-0" />
                  <div>
                    <h4 className="font-bold text-secondary mb-2">Continuous Standards</h4>
            ...
            <CardContent className="p-4 sm:p-6 md:p-8">
              <div className="text-center">
                <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3 sm:mb-4">
                  Are You a Professional Looking to Join us?
                </h2>
                ...
                <Button 
                  size="lg"
                  className="bg-primary hover:opacity-90 text-white font-bold"
