...
export default function UserManagement({ accessToken, currentUser }: UserManagementProps) {
  ...
  const getRoleIcon = (role: string) => {
    switch (role) {
      ...
      case 'manager':
        return <UserCog className="w-4 h-4 text-secondary" />;
      case 'talent':
        ...
        <CardContent className="p-6">
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            <div className="flex-1 relative">
              ...
              <Input
                ...
                className="pl-10 min-h-[44px] sm:h-12 border-2 border-gray-200 focus:border-primary rounded-xl"
              />
            </div>
            <Select value={filterRole} onValueChange={setFilterRole}>
              <SelectTrigger className="w-full md:w-48 min-h-[44px] sm:h-12 border-2 border-gray-200 focus:border-primary rounded-xl">
          ...
          {loading ? (
            ...
            <div className="text-center py-16 bg-gradient-to-br from-[#f5f1eb] to-[#ebe4d8] rounded-xl">
              ...
              <h3 className="text-lg font-semibold text-secondary mb-2">No Users Found</h3>
            ...
            <div className="space-y-4">
              {filteredUsers.map((user) => (
                <div 
                  key={user.id} 
                  className="card-premium border-2 border-gray-200 rounded-xl p-4 sm:p-5 hover:border-primary transition-all duration-300 bg-white hover-lift"
                >
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-2">
                        <h3 className="font-bold text-base sm:text-lg text-secondary tracking-tight">{user.name}</h3>
                    ...
                    {canEditRoles && user.id !== currentUser.id && (
                      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 w-full sm:w-auto">
                        ...
                        >
                          <SelectTrigger className="w-full sm:w-48 border-2 border-gray-200 focus:border-primary rounded-xl min-h-[44px] sm:min-h-0 sm:h-10">
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
