...
function buildPageMeta(): Record<string, PageMeta> {
  ...
  return {
    home: {
      title: `${siteName} | GPR Surveys, Utility Location & Geotechnical Solutions Jamaica`,
      description:
        'Webian Contracting & Geophysics Ltd (WCI Geophysics) provides Ground Penetrating Radar surveys, utility location, geotechnical and geological solutions, infrastructure assessment, and concrete evaluation across Jamaica and the Caribbean.',
      keywords:
        'GPR Jamaica, Ground Penetrating Radar Jamaica, geotechnical solutions Jamaica, utility location Jamaica, geophysics Jamaica, WCI Geophysics, infrastructure assessment, concrete assessment, non-destructive testing Jamaica',
      canonical: baseUrl + '/',
      ogTitle: `${siteName} | GPR & Geotechnical Solutions Jamaica`,
      ogDescription:
    ...
    services: {
      title: `GPR Services & Geotechnical Solutions | ${siteName}`,
      description:
      ...
      keywords:
        'GPR services Jamaica, geotechnical services Jamaica, utility mapping Jamaica, cavity detection, void detection, sinkhole detection Jamaica, concrete scanning Jamaica, infrastructure inspection, environmental site assessment Jamaica, road pavement evaluation',
      canonical: baseUrl + '/#services',
      ogTitle: `GPR & Geotechnical Services | ${siteName}`,
      ogDescription:
    ...
    portfolio: {
      ...
      keywords:
        'GPR projects Jamaica, geotechnical projects Caribbean, WCI Geophysics portfolio, subsurface investigation Jamaica, utility location projects, infrastructure assessment case studies',
    ...
    about: {
      ...
      description:
        'WCI Geophysics was founded by Damian Moodie in 2011 to provide Jamaica and the Caribbean with cutting-edge applied geophysics. Learn about our mission, story, and commitment to geotechnical excellence using Ground Penetrating Radar.',
      keywords:
      ...
      ogDescription:
        'Founded in 2011, WCI Geophysics provides geotechnical engineers and developers across Jamaica with cutting-edge GPR and applied geophysics solutions.',
    },
    'coverage-areas': {
      title: `Service Areas – All 14 Parishes of Jamaica | ${siteName}`,
      description:
        'Webian Contracting serves all 14 parishes of Jamaica with GPR surveys, utility location, geotechnical solutions, and infrastructure assessment. From Kingston to Montego Bay, St. Thomas to Westmoreland – full island coverage.',
      keywords:
        'geophysics Kingston Jamaica, GPR St. Andrew, utility location Montego Bay, geotechnical services St. Catherine, infrastructure assessment Portland Jamaica, GPR surveys island-wide Jamaica, subsurface investigation all parishes Jamaica',
      canonical: baseUrl + '/#coverage-areas',
      ogTitle: `Service Areas – Jamaica Island-Wide | ${siteName}`,
      ogDescription:
        'GPR and geotechnical services across all 14 parishes of Jamaica. From Kingston to Montego Bay – full island coverage by WCI Geophysics.',
    },
    'vetting-process': {
      title: `Our Quality & Vetting Standards | ${siteName}`,
      description:
        'Learn about WCI Geophysics rigorous vetting process, quality standards, and professional methodology for geotechnical and geophysical services in Jamaica. ISO-aligned standards and professional reporting.',
      keywords:
        'geophysics quality standards Jamaica, GPR methodology, professional geotechnical reporting Jamaica, WCI quality assurance, non-destructive testing standards',
    ...
    'terms-policies': {
      ...
      description:
        'Read the terms of service, privacy policy, and data protection policies for Webian Contracting & Geophysics Ltd. Transparent and fair business practices for all geotechnical and geophysical engagements.',
      keywords:
    ...
    signup: {
      ...
      description: `Create a free account with ${siteName} to request quotes for GPR surveys, geotechnical solutions, and infrastructure assessments in Jamaica.`,
      keywords: 'WCI Geophysics signup, request GPR quote Jamaica, geotechnical quote Jamaica',
